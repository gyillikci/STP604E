"""
Generate PDF documentation for Assignment 2 Problem 1 Analysis
"""
...
<h2>Conclusion</h2>
<div class="success-box">
    <p style="font-size: 18px; margin: 0;">The optimal design θ₁ = ±8°, θ₂ = 61° achieves <strong>minimum thermal expansion</strong>.</p>
    <p style="margin: 10px 0 0 0;">✅ Global optimum confirmed through exhaustive search</p>
...
def main():
    ...
    print("="*60)
    print("Generating Problem 1 Analysis PDF")
    print("="*60)
    
    # Generate HTML
    html_content = generate_analysis_html()
    
    html_file = Path("assignment_2/PROBLEM1_ANALYSIS.html")
    pdf_file = Path("assignment_2/PROBLEM1_ANALYSIS.pdf")
